...
if __name__ == "__main__":
    ...
    # Tool response — check no PII leaks
    run("What is the status of order ORD002?", user_id="user_002")

    # Escalation — check refusal scanner doesn't flag handoff message
    run("I want to speak to a human", user_id="user_003")
